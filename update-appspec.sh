...
# Dynamically generate hook names based on the function name
BEFORE_ALLOW_TRAFFIC_HOOK="${LAMBDA_FUNCTION_NAME}-BeforeAllowTraffic"
AFTER_ALLOW_TRAFFIC_HOOK="${LAMBDA_FUNCTION_NAME}-AfterAllowTraffic"

sed -i "s/{{BEFORE_ALLOW_TRAFFIC_HOOK}}/$BEFORE_ALLOW_TRAFFIC_HOOK/g" "$APPSPEC_FILE"
sed -i "s/{{AFTER_ALLOW_TRAFFIC_HOOK}}/$AFTER_ALLOW_TRAFFIC_HOOK/g" "$APPSPEC_FILE"
